...
// format de test pour skype. A supprimer plus tard
	DEFINE_VIDEOFORMATDESC(video_format::x1080i6001			,1920, 1080, 1920, 1080, field_mode::upper,			30,		1,		boost::assign::list_of(320),							L"1080i6001"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x2160p5994			,3840, 2160, 3840, 2160, field_mode::progressive,	60000,  1001,	boost::assign::list_of(1602)(1601)(1602)(1601)(1602),   L"2160p5994"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x5760x1280p2500	,5760, 1280, 5760, 1280, field_mode::progressive,	25,		1,		boost::assign::list_of(1920),							L"5760x1280p2500"),
	DEFINE_VIDEOFORMATDESC(video_format::x5760x1280p5000	,5760, 1280, 5760, 1280, field_mode::progressive,	50,		1,		boost::assign::list_of(960),							L"5760x1280p5000"),
	DEFINE_VIDEOFORMATDESC(video_format::x8400x1680p2500	,8400, 1680, 8400, 1680, field_mode::progressive,	25,		1,		boost::assign::list_of(1920),							L"8400x1680p2500"),
	DEFINE_VIDEOFORMATDESC(video_format::x8400x1680p5000	,8400, 1680, 8400, 1680, field_mode::progressive,	50,		1,		boost::assign::list_of(960),							L"8400x1680p5000"),
	DEFINE_VIDEOFORMATDESC(video_format::x8640x1920p2500	,8640, 1920, 8640, 1920, field_mode::progressive,	25,		1,		boost::assign::list_of(1600),							L"8640x1920p2500"),
	DEFINE_VIDEOFORMATDESC(video_format::x8640x1920p5000	,8640, 1920, 8640, 1920, field_mode::progressive,	50,		1,		boost::assign::list_of(1920),							L"8640x1920p5000"),

	DEFINE_VIDEOFORMATDESC(video_format::x8400x1680p3000	,8400, 1680, 8400, 1680, field_mode::progressive,	30,		1,		boost::assign::list_of(1600),							L"8400x1680p3000"),
	DEFINE_VIDEOFORMATDESC(video_format::x8400x1680p6000	,8400, 1680, 8400, 1680, field_mode::progressive,	60,		1,		boost::assign::list_of(800),							L"8400x1680p6000"),
	DEFINE_VIDEOFORMATDESC(video_format::x8640x1920p3000	,8640, 1920, 8640, 1920, field_mode::progressive,	30,		1,		boost::assign::list_of(1600),							L"8640x1920p3000"),
	DEFINE_VIDEOFORMATDESC(video_format::x8640x1920p6000	,8640, 1920, 8640, 1920, field_mode::progressive,	60,		1,		boost::assign::list_of(800),							L"8640x1920p6000"),
